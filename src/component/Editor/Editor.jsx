...
const Editor = (props) => {
        ...
        <div className="detail">
            ...
            <div className="row">
                <InputControl 
                  label="Start Date"
                  type="date"
                  placeholder="Enter start date of this eduction"
                  value={values.startDate}
                  onChange={(event)=>
                    setValues(prev=>({...prev, startDate: event.target.value}))
                  }
                ...
                <InputControl 
                  label="End Date"
                  type="date"
                  placeholder="Enter end date of this eduction"
                  value={values.endDate}
                  onChange={(event)=>
                    setValues(prev=>({...prev, endDate: event.target.value}))
                  }
    ...
    const basicInfoBody = (
        <div className="detail">
            <div className="row">
                <InputControl 
                  label="Name"
                  placeholder="Enter your full name eg. Ayush"
                  value={values.name}
                  onChange={(event)=>
                ...
                <InputControl 
                  label="Title"
                  placeholder="Enter your eg. Frontend developer"
                  value={values.title}
                  onChange={(event)=>
                    setValues(prev=>({...prev, title: event.target.value}))
                  }
            ...
            <div className="row">
                ...
                <InputControl 
                  label="Github Link"
                  placeholder="Enter your githun profile link"
                  value={values.github}
                  onChange={(event)=>
                    setValues(prev=>({...prev, github: event.target.value}))
                  }
    ...
    useEffect(()=> {
      ...
      setValues({
        ...
        companyName:  activeInfo?.details ? activeInfo.details[0]?.comapanyName || "" : "",
        ...
        points:  activeInfo?.details ? activeInfo.details[0]?.points ? [...activeInfo[0]?.points] : "" : activeInfo?.points ? [...activeInfo.points] : "",
    ...
    <div className="editor">
        <div className="header_editor">
            {Object.keys(sections)?.map((key) => ( 
                <div 
                   className= {`${"section_editor"} ${activeSectionKey === key ? "active" : ""}`} 
                   key={key}
        ...
        <div className="body_editor">
            <InputControl 
              label="Title" 
              placeholder="Enter sectioin title" 
              value = {sectionTitle}
            ...
            <div className="chips">
              {
                ...
                activeInformation?.details?.map((item, index)=> (
                  <div className=
                   {`${"chip"} ${activeDetailIndex === index ? "active" : ""}`}
